...
a bit smaller circle is drawn atc till the center of a circle. For every number 
...
You have to use very fine pencilsto see the sperate circles above 8 bits.
